...
export default function Home() {
    ...
    return(
        <div className={`bg-base-300 rounded-4xl p-6 shadow-lg h-150 w-450 m-auto mt-20 transition ${isVisible ? 'opacity-100 translate-y-0 delay-100' : 'opacity-0 translate-y-10'} `}>
            <div className="grid grid-cols-3 gap-5">
                <div className={`flex justify-center mt-4 transition ${isVisible ? 'opacity-100 translate-y-0 delay-1100' : 'opacity-0 translate-y-30'}`}>
                    <img
                        src={pic1}
                        ...
                        className="h-130 w-100 rounded-4xl transition duration-300 hover:scale-110"
                    />
                </div>
                <div className={`text-center m-auto transition ${isVisible ? 'opacity-100 translate-y-0 delay-300' : 'opacity-0 translate-y-15'}`}>
                ...
                <div className={`flex justify-center mt-4 transition ${isVisible ? 'opacity-100 translate-y-0 delay-1300' : 'opacity-0 -translate-y-30'}`}>
                    <img
                        src={pic2}
