...
export default function Home() {
    ...
    return(
        <div className="grid grid-cols-3">
            <div className={`flex justify-center mt-15 transition ${isVisible ? 'opacity-100 translate-y-0 delay-1000' : 'opacity-0 translate-y-5'}`}>
                <img src={pic1} alt="Picture of Alex Guo" className="h-110 w-80 rounded-4xl transition duration-300 hover:scale-120"></img>
            </div>
            <div className={`text-center mt-24 transition ${isVisible ? 'opacity-100 translate-y-0 delay-500' : 'opacity-0 translate-y-5'}`}>
