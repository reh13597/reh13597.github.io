...
export default function Home() {
    ...
    return(
        <div className="grid grid-cols-3">
            <div className={`flex justify-center mt-30 transition ${isVisible ? 'opacity-100 translate-y-0 delay-500' : 'opacity-0 translate-y-5'}`}>
                <img src={pic1} alt="Picture of Alex Guo" className="h-130 w-100 rounded-4xl transition duration-300 hover:scale-120"></img>
            </div>
            <div className={`text-center mt-35 transition ${isVisible ? 'opacity-100 translate-y-0 delay-100' : 'opacity-0 translate-y-5'}`}>
