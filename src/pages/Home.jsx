...
export default function Home() {
    ...
    return(
        <div className={`bg-base-300 rounded-4xl p-6 shadow-lg mt-20 h-170 w-450 mx-auto transition ${isVisible ? 'opacity-100 translate-y-0 delay-100' : 'opacity-0 translate-y-10'} `}>
            <div className="grid grid-cols-3 gap-5">
                <div className={`flex justify-center mt-14 transition ${isVisible ? 'opacity-100 translate-y-0 delay-1100' : 'opacity-0 translate-y-30'}`}>
                    <img
                        src={pic1}
                        ...
                        className="h-130 w-100 rounded-4xl transition duration-300 hover:scale-120"
                    />
                </div>
                <div className={`text-center mt-14 transition ${isVisible ? 'opacity-100 translate-y-0 delay-300' : 'opacity-0 translate-y-15'}`}>
                    <div className="cursor-default select-none transition duration-300 hover:scale-130">
                ...
                <div className={`flex justify-center mt-14 transition ${isVisible ? 'opacity-100 translate-y-0 delay-1300' : 'opacity-0 -translate-y-30'}`}>
                    <img
                        src={pic2}
