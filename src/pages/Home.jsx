...
export default function Home() {
    ...
    return(
        <div className="grid grid-cols-3">
            <div className={`flex justify-center mt-30 transition ${isVisible ? 'opacity-100 translate-y-0 delay-300' : 'opacity-0 translate-y-15'}`}>
                <img
                    src={pic1}
            ...
            <div className={`text-center mt-35 transition ${isVisible ? 'opacity-100 translate-y-0 delay-100' : 'opacity-0 translate-y-15'}`}>
                <div className="transition duration-300 hover:scale-130">
                    ...
                    <p className="text-4xl mt-5">In my free time, I love to play video games, watch anime, go on hikes, and ski with my buddies.</p>
