...
export default function Projects() {
    return(
        <div className="bg-base-300 rounded-4xl pl-10 w-[80%]">
            <div className="grid grid-cols-2 gap-5">
                ...
                <div className="flex">
                    <ProjectCard
                        ...
                        items={['Python', 'HuggingFace', 'AI', 'scikit-learn', 'pandas', 'numPy', 'spaCy', 'sciPy', 'matplotlib', 'seaborn', 'joblib', 'Logistic Regression', 'Cosine Similarity', 'Job/Co-op Applications']}
