            ...
            <div className="columns-2 lg:columns-3 gap-2 sm:gap-4 space-y-3">
                {galleryItems.map((item, index) => (
                    <img
                        ...
                        src={item.img}
                        alt="Alex"
                        className="w-full h-auto break-inside-avoid rounded-2xl border-4 border-neutral hover:border-primary/80 hover:border-3 transition duration-200 hover:scale-102 shadow-2xl shadow-primary/25 hover:shadow-primary/30"
                    />
                ))}
            </div>
        </div>
