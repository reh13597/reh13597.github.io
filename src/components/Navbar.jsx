...
export default function Navbar() {
    ...
    return(
        ...
        >            <div className="bg-base-100/50 backdrop-blur-xs rounded-2xl px-6 py-3 shadow-2xl shadow-primary/10 hover:shadow-primary/20 border border-neutral hover:border-primary/50 transition-all duration-300">
