...
export default function Navbar() {
    ...
    return(
        <div className={`navbar bg-base-300 shadow-sm transition ${isVisible ? 'opacity-100 translate-y-0 delay-1500' : 'opacity-0 translate-y-5'}`}>
            ...
            <div className="navbar-center">
                <div role="tablist" className="flex-auto tabs tabs-border tabs-xl text-primary">
                    ...
                    <a role="tab" href="/coding" className={`tab transition duration-300 hover:scale-110 ${pathName === '/coding' ? 'tab tab-active' : ''}`}>Coding</a>
                    <a role="tab" href="contact" className={`tab transition duration-300 hover:scale-110 ${pathName === '/contact' ? 'tab tab-active' : ''}`}>Contact</a>
                </div>
            </div>
