        ...
        <div className={`navbar bg-base-300 shadow-sm transition ${isVisible ? 'opacity-100 translate-y-0 delay-100' : 'opacity-0 translate-y-5'}`}>
            ...
            <div className="navbar-end">
                <div className="flex flex-none gap-2">
                    ...
                    <a target="_blank" href="https://www.linkedin.com/in/alex-guo-3088461ba/"className="btn btn-ghost btn-primary transition duration-300 hover:scale-110"><img src={linkedinIcon} alt="LinkedIn Hyperlink" className="h-6 w-6" /></a>
                </div>
            </div>
        </div>
    );
